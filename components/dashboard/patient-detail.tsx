...
import { getWeightHistory, getAdherenceHistory, getMoodHistory, getPatientSymptoms } from "@/lib/mock-data"
import { 
  Scale, 
  Ruler, 
  Calendar, 
    ...
    <div className="space-y-4">
      ...
      <Card className="bg-card border-border">
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium text-foreground">Niveles de Alerta</CardTitle>
        </CardHeader>
        <CardContent>
